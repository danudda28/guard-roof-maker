...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Metallic Group — garduri și acoperișuri metalice" },
      {
        name: "description",
        content:
          "Producător român de garduri metalice, țiglă metalică și tablă click. Consultanță gratuită și livrare în toată țara.",
      },
      { name: "author", content: "Metallic Group" },
    ...
    links: [
      {
        rel: "stylesheet",
        // In dev the sandbox server doesn't serve /src/*, so use the dev CSS endpoint.
        href: import.meta.env.DEV ? "/@tanstack-start/styles.css?routes=__root__" : appCss,
      },
